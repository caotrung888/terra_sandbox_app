...
fun ApplicationProductFlavor.buildConfigStringField(name: String, value: String) {
 ...
 */
@Suppress("UnstableApiUsage")
fun ApplicationProductFlavor.buildConfigIntField(name: String, value: Int) {
 ...
 */
@Suppress("UnstableApiUsage")
fun ApplicationProductFlavor.buildConfigBooleanField(name: String, value: Boolean) {
